...
export const IntroSplash = ({ onComplete }: IntroSplashProps) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-[#681403] flex items-center justify-center transition-opacity duration-700 select-none ${
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 animate-in fade-in zoom-in-95 duration-1000">
