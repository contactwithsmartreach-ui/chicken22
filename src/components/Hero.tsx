...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-neutral-950 text-white pt-24 pb-16">
      {/* Background Video Layer with fallback and correct path resolution */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <video
          ...
          muted
          playsInline
          className="absolute inset-0 w-full h-full object-cover opacity-50 scale-105 filter brightness-75 contrast-125"
        >
          {/* Primary video source with correct GitHub Pages basePath */}
          <source src={getAssetPath("videos/restaurant_3d.mp4")} type="video/mp4" />
          {/* Reliable CDN fallback video URL */}
        ...
        {/* Luxury gradient vignette overlays */}
