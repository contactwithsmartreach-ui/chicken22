...
export default function Hero() {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-neutral-950 text-white pt-24 pb-16">
      {/* CSS-Powered 3D Animated Luxury Geometric Rings & Glowing Orbs (Guaranteed pure CSS rendering in static production) */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center">
        {/* Central Glowing Core */}
        <div className="absolute w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-amber-600/20 via-amber-400/10 to-yellow-300/30 blur-[100px] animate-pulse" />

        {/* Rotating 3D Rings */}
        <div className="absolute w-[380px] h-[380px] sm:w-[550px] sm:h-[550px] rounded-full border border-amber-500/30 animate-[spin_20s_linear_infinite]" style={{ transformStyle: "preserve-3d", perspective: "1000px" }} />
        <div className="absolute w-[300px] h-[300px] sm:w-[440px] sm:h-[440px] rounded-full border border-dashed border-amber-400/25 animate-[spin_15s_linear_infinite_reverse]" />
        <div className="absolute w-[220px] h-[220px] sm:w-[330px] sm:h-[330px] rounded-full border border-amber-300/40 animate-[spin_25s_linear_infinite]" />

        {/* Floating Particles */}
        <div className="absolute top-1/4 left-1/3 w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_15px_#fbbf24] animate-bounce" style={{ animationDuration: "3s" }} />
        <div className="absolute top-1/3 right-1/4 w-2 h-2 rounded-full bg-yellow-300 shadow-[0_0_12px_#fde047] animate-bounce" style={{ animationDuration: "4s" }} />
        <div className="absolute bottom-1/3 left-1/4 w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_15px_#f59e0b] animate-bounce" style={{ animationDuration: "3.5s" }} />
        <div className="absolute bottom-1/4 right-1/3 w-2 h-2 rounded-full bg-white shadow-[0_0_10px_#ffffff] animate-bounce" style={{ animationDuration: "5s" }} />
      </div>
